...
| API 문서 (Swagger) | http://43.200.8.205:8000/docs |

> 배포 버전에는 **자소서 작성**과 **면접 연습** 기능이 포함되어 있습니다.
> 음성 대화형 면접은 마이크/스피커가 필요한 로컬 전용 기능으로, 서버 환경에서 동작하지 않아 제외했습니다.
> 음성 면접 시연은 아래 데모 영상을 참고해주세요.
...
- 컨테이너: Docker Compose 4개 서비스
- CI/CD: GitHub Actions (push 시 자동 테스트 + EC2 자동 배포)
